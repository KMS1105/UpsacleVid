...
UI_TEXTS = {
    'ko': {
        ...
        'tab_remove_bg': '배경 제거',
        'input_file': '파일 입력 (이미지/비디오)',
        'run_rembg': '배경 제거 실행',
        'log_rembg_start': '✨ 작업을 시작합니다: {0}',
        'log_rembg_success': '✅ 완료: {0}',
        'log_rembg_fail': '❌ 실패: {0}',
    },
    'en': {
        ...
        'input_file': 'Input File (Img/Vid)',
        'run_rembg': 'Run Remove BG',
        'log_rembg_start': '✨ Starting: {0}',
        'log_rembg_success': '✅ Done: {0}',
        'log_rembg_fail': '❌ Failed: {0}',
    }   
}
